        ...
        <Section style={informationTable}>
          <Row style={informationTableRow}>
              ...
              <Section>
                ...
                <Row>
                  ...
                  <Column style={informationTableColumn}>
                    ...
                    <Text style={informationTableValue}>{documentNo}</Text>
                  </Column>
                </Row>
              </Section>
            </Column>
            <Column style={informationTableColumn} colSpan={2}>
              ...
              <Text style={informationTableValue}>{fullName}</Text>
              <Text style={informationTableValue}>{address}</Text>
              <Text style={informationTableValue}>{city}</Text>
        ...
        {components?.map((item: any, index: any) => {
              return (
                <Section key={index}>
                  ...
                  {item.componentType === "apple-card-purchase" ? (
                    <Section>
                      <Section>
                        <Row>
                      ...
                      <Section>
                        <Row>
                          <Column align="center" style={ctaTitle}>
                            <Text style={ctaText}>{item.componentText || 'Save 13% on All Apple Purchases'}</Text>
                          </Column>
                        </Row>
                      </Section>
                      <Section>
...
export function renderEmail(inputs: any, payload: any) {
  return render(<AppleReceiptEmail {...inputs} {...payload} />);
}